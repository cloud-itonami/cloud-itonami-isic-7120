# Operator Quickstart — Technical testing and analysis

Shortest path from clone to a verified local dry-run for **ISIC 7120** (`cloud-itonami-isic-7120`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-7120.git
cd cloud-itonami-isic-7120
```
...
- Blueprint governor key: `test-integrity-governor`
- Likely source path: `testlab.governor.cljc`
