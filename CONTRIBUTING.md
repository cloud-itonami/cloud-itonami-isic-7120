...
`cloud-itonami-isic-7120` accepts contributions to the OSS blueprint, capability
...
- Keep issuing a test result or certification behind the Test Integrity Governor.
